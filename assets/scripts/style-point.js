...
let fillData = (points) => {
  let heading = document.getElementsByClassName(".style-point__title");
  let description = document.getElementsByClassName(".style-point__text");

  heading.innerHTML += points.title;
  description.innerHTML += points.text;
};
